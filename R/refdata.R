...
#'   \item{ringing_sex_code}{Bird Sex Code}
#'   \item{ringing_sex}{Sex}
#'   \item{ringing_age_code}{Age Code}
#'   \item{ringing_age}{Age}
#'   \item{ringing_date}{Ringing Date}
#'   \item{ringing_lat}{Ringing Latitude}
...
#'   \item{recovery_date_accu}{Recovery Date Accuracy}
#'   \item{recovery_lat}{Recovery Latitude}
#'   \item{recovery_lon}{Recovery Longitude}
...
#'   \item{ringing_sex_code}{Könskod}
#'   \item{ringing_sex}{Kön}
#'   \item{ringing_age_code}{Ålderskod}
#'   \item{ringing_age}{Ålder}
#'   \item{ringing_date}{Märkdatum}
#'   \item{ringing_lat}{Märklatitud}
...
#'   \item{recovery_date_accu}{Fynddatumets noggrannhet}
#'   \item{recovery_lat}{Fyndets latitud}
#'   \item{recovery_lon}{Fyndets longitud}
...
#'   \item{desc_eng}{Translation in English}
#'   ...
#'   }
#' @source \url{}
"birdrecoveries_i18n"
